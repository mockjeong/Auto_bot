...
while progress==0:
    ...
    try:
        ...
        button_type = driver.find_element("xpath","/html/body/div[1]/div[3]/div/div[1]/form[1]/div/div[4]/table[1]/tbody/tr[1]/td[6]/a[1]/img").get_attribute('alt')
        ...
        try:
            ...
            button_type = driver.find_element("xpath","/html/body/div[1]/div[3]/div/div[1]/form[1]/div/div[4]/table[1]/tbody/tr[1]/td[6]/img").get_attribute('alt')
